...
class CustomDataset(Dataset):
    ...
    def __init__(self, data_root, prefix, suffix, voxel_cfg=None, training=True, repeat=1, with_normal=True, logger=None):
    ...
    def transform_train(self, xyz, rgb, semantic_label, instance_label, spp, normal=None, aug_prob=1.0):
        ...
        return xyz, xyz_middle, rgb, semantic_label, instance_label, spp, normal

    def transform_test(self, xyz, rgb, semantic_label, instance_label, spp, normal=None):
    ...
    def __getitem__(self, index):
        ...
        xyz, rgb, semantic_label, instance_label, spp, normal = self.load(filename)

        data = (
            self.transform_train(xyz, rgb, semantic_label, instance_label, spp, normal)
            if self.training
            else self.transform_test(xyz, rgb, semantic_label, instance_label, spp, normal)
        )
        if data is None:
            return None

        xyz, xyz_middle, rgb, semantic_label, instance_label, spp, normal = data
